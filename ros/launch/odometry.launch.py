...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("dynamic_vehicle_filter_th", default_value="0.5"), # Dynamic vehicle filter threshold, 0.5
            ...
            # semantic matching params
            DeclareLaunchArgument("sem_th", default_value="0.4"), # Semantic matching threshold, 0.4
