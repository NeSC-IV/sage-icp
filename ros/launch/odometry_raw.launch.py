...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("voxel_size_road", default_value="1.2"), # Road voxel size
            DeclareLaunchArgument("voxel_size_building", default_value="1.0"), # Building voxel size
            DeclareLaunchArgument("voxel_size_plant", default_value="1.2"), # Plant voxel size
            DeclareLaunchArgument("voxel_size_object", default_value="0.2"), # Object voxel size
            ...
            DeclareLaunchArgument("sem_th", default_value="0.2"), # Semantic segmentation threshold
